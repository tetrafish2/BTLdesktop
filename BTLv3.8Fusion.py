...
def create_new_zip(desktop_dir):
    ...
    add_icon(300,200,"🗜️", os.path.basename(zip_path), lambda: os.startfile(zip_path), deletable=True)
...
add_icon(850,50,"📊","Görev Yöneticisi", open_task_manager, deletable=False)
...
def open_start_menu():
    ...
    Button(menu, text="🎨 Paint", command=open_paint).pack(fill="x")
